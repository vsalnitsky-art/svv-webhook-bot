        ...
        try:
            ...
            for t in all_trades:
                ...
                if filter_start and filter_end:
                    if filter_start <= exit_dt <= filter_end: filtered_trades.append(t)
                else: filtered_trades.append(t)

            stats = {
                "total_trades": len(filtered_trades), "total_pnl": 0.0, "total_volume": 0.0,
