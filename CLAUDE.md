...
(сила ≥10) **і НЕ слабшає** (стрілка ↑ або →; гасне ЛИШЕ на ↓, тобто коли тиск
у бік згасає — раніше вимагалось СТРОГО ↑, тож на плато сильного руху шар МММ
майже ніколи не світився) · 2) SCORE ≥ СЕРЕДНІЙ (≥40) · 3) Готовність(1H) ≥
СЕРЕДНІЙ (≥38) · 4) Скальп ≥ СЕРЕДНІЙ (≥38) ·
