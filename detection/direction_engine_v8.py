...
class DirectionEngineV8:
    ...
    BIAS_THRESHOLD_LONG = 0.10   # v8.2.5: Знижено з 0.15 для кращої детекції
    BIAS_THRESHOLD_SHORT = -0.10  # v8.2.5: Знижено з -0.15
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        if config:
            ...
            self.BIAS_THRESHOLD_LONG = config.get('bias_threshold_long', 0.10)
            self.BIAS_THRESHOLD_SHORT = config.get('bias_threshold_short', -0.10)
