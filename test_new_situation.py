...
def test_wait_formatting():
    ...
    # 24.09: від доби — дні, а не «40г 47хв».
    _check(FF._fmt_wait(40 * 3600 + 47 * 60) == '1д 16г 47хв', FF._fmt_wait(40 * 3600 + 47 * 60))
    _check(FF._fmt_wait(24 * 3600) == '1д 0г 00хв', FF._fmt_wait(24 * 3600))
    _check(FF._fmt_wait(23 * 3600 + 59 * 60) == '23г 59хв', 'менше доби — без днів')
